...
public class SalesMan extends Employee {
      public SalesMan(String name, int age,int id,int salary) {
	...
	public String toString() {
		return String.format("Name:%s Age:%d Target: %d, Commision: %f\n",super.getName(),super.getAge(),this.target, this.commision);	
	}
